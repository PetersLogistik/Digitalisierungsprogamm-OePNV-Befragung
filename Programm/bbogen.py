...
# Erstellzeitraum: 03.12.2022 18.30-00.30
#
...
# Ausführung #
    ...
    def pruef(self):
        ...
        elif self.ausstieg.currentIndex() >= self.comboBox_Erhebunsabschnitt.currentIndex():
            self.statusbar.showMessage("Fehler: Einstieg und Erhebungsabschnitt sind fehlerhaft!")  
